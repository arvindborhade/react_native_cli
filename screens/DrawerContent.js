                  ...
                  <View style={styles.drawerContent}>
                      <View style={styles.userInfoSection}>
                          <View style={{flexDirection:'row',marginTop: 15}}>
                                <Avatar.Image
                                source={{
                                    uri: 'https://atechguides.org/wp-content/uploads/2018/11/steam-avatar-profile-picture-0013.jpg'
                                }}
                                size={50}
                                />
                                <View style={{marginLeft: 20, flexDirection:'column'}}>
                                    <Title style={styles.title}>Pikaa</Title>
                                    <Caption style={styles.caption}>@itzpika</Caption>
                                </View>
                            </View>
